...
const LightPillar = ({
  ...
  if (!webGLSupported) {
    return (
      <div className={`${styles['light-pillar-fallback']} ${className}`} style={{ mixBlendMode }}>
        WebGL not supported
      </div>
    );
  }

  return <div ref={containerRef} className={`${styles['light-pillar-container']} ${className}`} style={{ mixBlendMode }} />;
};
